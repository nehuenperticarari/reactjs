        ...
        <header style={{backgroundColor: "rgb(95, 121, 143)"}} className="text-white body-font" >
          <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
              ...
              <a href="" className="mr-5 hover:text-gray-900">Hombres</a>
              <a href="" className="mr-5 hover:text-gray-900">Mujeres</a>
              <a href="" className="mr-5 hover:text-gray-900">Nosotros</a>
